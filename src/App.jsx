...
const resources = [
  { title: 'School Counselors', description: 'Trusted adults who can help you navigate academic pressure.' },
  { title: 'Mental Health Resources', description: 'Tools and hotlines for stress, anxiety, and emotional support.' },
  { title: 'Study Tools', description: 'Apps and systems that help you work smarter and stay calm.' },
];
    ...
    <div className="min-h-screen bg-surface text-slate-900">
      <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl flex-col gap-4 p-6 md:flex-row md:items-center md:justify-between">
          <div>
            <a href="#home" className="text-lg font-semibold text-brand">The Pressure Paradox</a>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {resources.map((item) => (
              <motion.a
                key={item.title}
                href="#contact"
                className="group rounded-[32px] border border-slate-200 bg-white p-6 shadow-soft transition hover:-translate-y-1 hover:border-brand"
              >
                <h3 className="text-xl font-semibold text-slate-950 group-hover:text-brand">{item.title}</h3>
